...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        ...
        <div class="page-header">
          <div class="row">
            <div class="col-lg-12">
              <h2 class="mb-3 line-head" id="buttons">ÖZET FORM</h2>
            </div>
          </div>
        </div>
        <div class="row">
 ...
 $query = $db->query("SELECT * FROM sorular", PDO::FETCH_ASSOC);
if ( $query->rowCount() )
...

{
    ...
    echo "Geliri:".$row['gelir']."</br>";
    echo "Evin Durumu:".$row['evin_durumu']."</br>";
    echo "Evin Fiziki Durumu:".$row['fiziki_durum']."</br>";
    echo "Evin isinma durumu".$row['isinma_durumu']."</br>";
    echo ".................................................."."</br>";
