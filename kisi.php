            ...
            <section class="invoice">
              <div class="row mb-4">
                ...
                <div class="col-6">
                   ...
                   <img src="logojpg" style="height: 80px;"></img>


                </div>
                <div class="col-6">

                  <h5 class="text-right"><?php echo date("d-m-Y H:i");//2016-02-17 15:25:14 ?></h5>
                </div>
              </div>
              <div class="row invoice-info">

                <div class="col-4"><h3>Kişisel Bilgiler</h3>
...

{
 ...
 echo "<tr>";
    ...
    echo "Ad:"."<td>"." ".$row['username'],"</td>". "</br>";
    echo "Soyad:"."<td>"." ".$row['username_surname'],"</td>"."</br>";
        echo "TC Kimlik:"."<td>"." ".$row['tc_kimlik'],"</td>"."</br>";
    echo "</tr>";
...

{
 ...
 echo "<tr>";
    echo "<b>"."1.Geliri"."</b>"."<td>",$row['gelir'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."2.Evin Durumu"."</b>"."<td>",$row['evin_durumu'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."3.Evin Fiziki Durumu"."</b>"."<td>",$row['fiziki_durum'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."4.Evin ısınma durumu"."</b>"."<td>",$row['isinma_durumu'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."5.Ailedeki birey sayısı"."</b>"."<td>",$row['aile_birey'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."6.Ailedeki okuyan sayısı"."</b>"."<td>",$row['okuyan_sayi'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."7.Ailede üniversite okuyan kişi sayısı"."</b>"."<td>",$row['uni_sayisi'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."8.Yaşlılık Maaşı"."</b>"."<td>",$row['y_maas'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."9.Özürlülük Maaşı"."</b>"."<td>",$row['ozur_maas'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."10.Herhangi bir kurumdan yardım alınıyor?"."</b>"."<td>",$row['kurum'],"</td>"."</br>";
    echo "</br>";
    echo "<b>"."11.Ailedeki çalışabilecek kişi sayısı"."</b>"."<td>",$row['calisan_kisi'],"</td>"."</br>";
    echo "</br>";
    echo "<tr>";
    echo "----------------------------------------------------------"."</br>";
