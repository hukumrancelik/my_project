  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        ...
        <div class="page-header">
          <div class="row">
            <div class="col-lg-12">
              <h2 class="mb-3 line-head" id="buttons">Cinsiyete Göre Analizler: ERKEK</h2>
            </div>
          </div>
        </div>
        <div class="row">
